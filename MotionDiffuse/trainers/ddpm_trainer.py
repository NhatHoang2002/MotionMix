...
class DDPMTrainer(object):
    ...
    def forward(self, batch_data, eval_mode=False):
        caption, motions, m_lens, clean_mask = batch_data
        ...
        t, _ = self.sampler.sample(B, x_start.device, clean_mask, self.opt.t_noise_pivot)
    ...
    def generate_batch(self, captions, m_lens, dim_pose):
