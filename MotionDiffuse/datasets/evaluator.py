...
class EvaluationDataset(Dataset):
    ...
    def __init__(self, opt, trainer, dataset, w_vectorizer, num_sample_limit, mm_num_samples, mm_num_repeats):
        ...
        if num_sample_limit != -1:
            real_num_batches = num_sample_limit // dataloader.batch_size + 1

        print("real_num_batches: %d" % real_num_batches)
...
def get_motion_loader(opt, batch_size, trainer, ground_truth_dataset, num_sample_limit, mm_num_samples, mm_num_repeats):
    ...
    dataset = EvaluationDataset(opt, trainer, ground_truth_dataset, w_vectorizer, num_sample_limit, mm_num_samples, mm_num_repeats)
