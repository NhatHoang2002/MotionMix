...
class TrainCompOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--t_noise_lower', type=int, default=0)
        self.parser.add_argument('--t_noise_upper', type=int, default=0)
        self.parser.add_argument('--t_noise_pivot', type=int, default=0)
        self.parser.add_argument('--noisy_ratio', type=float, default=0.0)
        self.parser.add_argument('--use_unlabeled_clean', action="store_true", help='Whether to use unlabeled clean data')
        self.is_train = True
