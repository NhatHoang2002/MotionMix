...
def parse_train_opt():
    ...
    parser.add_argument("--dataset", type=str, default="aistpp", choices=["aistpp", "mixdata"])
    parser.add_argument("--t_noise_lower", type=int, default=0)
    parser.add_argument("--t_noise_upper", type=int, default=0)
    parser.add_argument("--t_noise_pivot", type=int, default=0)
    parser.add_argument("--noisy_ratio", type=float, default=.0)
    parser.add_argument("--use_unlabeled_clean", action='store_true')
    parser.add_argument("--use_weighted_mix", action='store_true')
