...
def add_data_options(parser):
    ...
    group.add_argument("--t_noise_lower", default=0, type=int)
    group.add_argument("--t_noise_upper", default=0, type=int)
    group.add_argument("--t_noise_pivot", default=0, type=int)
    group.add_argument("--noisy_ratio", default=0.0, type=float)
    group.add_argument("--use_unlabeled_clean", action='store_true')
...
def add_sampling_options(parser):
    ...
    group.add_argument("--mask_at_time", default=-100, type=int)
